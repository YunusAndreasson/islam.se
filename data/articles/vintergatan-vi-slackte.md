...
För att förstå vad som står på spel måste vi först förstå hur det andliga ljuset beskrivs i den tradition som levt längst med mörkret. I Koranen är ljus inte bara metafor utan kosmologisk kategori. Den mest kommenterade versen i hela den islamiska idéhistorien – ljusversen, *āyat al-nūr* – gestaltar ljuset i en flerlagrad bild:
...
Invändningen väger tungt. Det ljus som Koranen omnämner i *āyat al-nūr* är vägledning, tro, klarhet som Allah ﷻ lägger i den troendes hjärta. Ingen mängd artificiellt ljus kan hindra Allah ﷻ från att vägleda den Han vill vägleda.

Men Koranen själv förankrar erkännandet i den fysiska erfarenheten av ljus och mörker. Den jämställer ljusversen och mörkerbilden i samma sura, som om den ena inte kan förstås utan den andra. Fem verser efter *nūrun ʿalā nūr* kommer detta:
...
Koranen tilltalar människor som *vet* hur mörker känns – som har stått i det och känt sin egen hjälplöshet. Den fysiska erfarenheten utgör den jordmån ur vilken erkännandet växer, om än skild från ljusets källa. I denna jordmån identifierar Ibn Qayyim i *Ighāthat al-Lahfān* en av hjärtats sjukdomar: ljuset fördunklas av ständig stimulans; den som vill återfå sin *baṣīrah* – sin inre syn – måste dra sig tillbaka från det som bländar.[^7] Den som stänger fliken, stiger upp från skärmen, går ut i tystnaden. Det som stiger bortom det fysiska måste ha *börjat* i det fysiska. Tar man bort jordmånen upphör inte sanningen – men färre ögon finner den.
...
Koranen formulerar det gudomliga ljusets natur som *nūrun ʿalā nūr* – ljus på ljus. Frasen förutsätter hierarki: ett ljus skiktas på ett annat och förstärker det. Utan kontrast, utan skiktning, reduceras frasen till tautologi. Ljus på ljus i en värld av jämnt, konstant ljus är bara ljus.
...
Guds ljus *framträder* i natten. Stjärnornas ljus är saligt just för att det visar sig mot mörker. Utan erfarenheten av stjärnor mot en svart himmel förblir meningen intellektuell. Men att erfara den, att stå under en oändlig himmel och känna sin egen litenhet som befrielse – det kräver mörker.

Koranen ger stjärnorna just denna roll: "Det är Han som har gett er stjärnorna för att ni genom dem skall kunna finna er väg i landets och havets mörker."[^21] Stjärnorna är vägvisare – och de fungerar bara i mörker. Och det de leder mot – sammanhanget i sura *al-Anʿām* tydliggör det – är mer än en fysisk destination: en tacksamhet född ur erfarenheten av egen hjälplöshet.
...
[^18]: Ibn Qayyim al-Jawziyyah, *Madārij al-Sālikīn* (De vandrandes stationer), avsnitt om *nūr*.
[^19]: Ibn Qayyim al-Jawziyyah, *Rawḍat al-Muḥibbīn* (De älskandes lustgård), kap. om blickens sänkning.
[^20]: Okänd svensk poet, *Lärkan: Poetisk kalender* (1800-tal).
[^21]: Koranen, al-Anʿām 6:97.
