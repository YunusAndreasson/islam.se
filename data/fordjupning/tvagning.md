...
sources:
  - name: "Koranen 5:6 (Knut Bernströms översättning)"
    url: "https://quran.com/5/6?translations=48"
  - name: "Koranen 9:28 (Knut Bernströms översättning)"
    url: "https://quran.com/9/28?translations=48"
  - name: "Förvaltningsrätten i Malmö, mål 7680-19, dom 2020-09-11 (Bromölla) – Sveriges Domstolar"
  ...
  - name: "AD 2018 nr 51, dom 2018-08-15 – Arbetsdomstolen"
    url: "https://arbetsdomstolen.se/sv/meddelade-domar/arkiverade-domar/2018/2018-08-15-ad-2018-nr-51/"
  - name: "Trossamfund – antal betjänade, officiell statistik 2024 – MUCF"
    url: "https://www.mucf.se/rapporter-och-statistik/trossamfund-antal-betjanade"
  - name: "SOSFS 2015:10 om basal hygien i vård och omsorg – Socialstyrelsen"
    url: "https://www.socialstyrelsen.se/kunskapsstod-och-regler/regler-och-riktlinjer/foreskrifter-och-allmanna-rad/konsoliderade-foreskrifter/201510-om-basal-hygien-i-vard-och-omsorg/"
  - name: "Religion och hälsa – Vårdhandboken (Inera), godkänd 2022-08-24"
    url: "https://www.vardhandboken.se/arbetssatt-och-ansvar/bemotande-i-vard-och-omsorg/bemotande-i-vard-och-omsorg-transkulturellt-perspektiv/religion-och-halsa/"
  - name: "Georg August Wallin, Första resa från Cairo till Arabiska öknen i april 1845 (utg. 1853) – Projekt Runeberg"
    url: "https://runeberg.org/wga1resa/"
...
Haditherna ger både princip och detalj. Hos Abu Malik al-Ashari står orden "renheten är halva tron".[^10] Enligt Ibn Umar tar Gud inte emot bön utan rening, och al-Bukhari har samma sak från Abu Hurayra.[^11] Aisha och Maymuna bint al-Harith har var sin utförlig beskrivning av hur Muhammed utförde ghusl, båda återgivna av al-Bukhari och Muslim, och de skiljer sig i detaljerna: Aisha nämner att han lät fingrarna gå genom håret tills hårbotten var fuktad, Maymuna att han slog handen mot marken eller väggen och att han avböjde handduken och skakade av vattnet med händerna.[^12] Mot den bakgrunden är Jubayr ibn Mutims korta tradering desto mer talande. När sällskapet diskuterade hur mycket vatten ghusl kräver svarade Muhammed att det för hans del räckte att ösa tre gånger över huvudet och därefter låta det rinna över resten av kroppen.[^13]
...
Fötterna, den tredje frågan, hänger på en enda bokstav. I 5:6 kan ordet *arjul* läsas i ackusativ, *arjulakum*, vilket kopplar fötterna till tvättningen, eller i genitiv, *arjulikum*, vilket kopplar dem till strykningen över huvudet. De två läsningarna hör hemma i de kanoniska recitationerna.[^18] Rättsskolorna är ändå eniga: fötterna tvättas. Ibn Abi al-Izz argumenterar i sin kommentar till al-Tahawis trosbekännelse för den läsningen med ett räkneargument: de som överlämnat tvagningen från Muhammed i ord och handling, och som lärde sig den av honom eftersom riten inte var känd i den förislamiska tiden, är fler än de som överlämnat versens ordalydelse.[^19] Det är den överlämnade handlingen som avgör vilken läsning som bär, inte tvärtom.

Den fjärde gäller strykning över fotbeklädnad, *mash*. Att stryka över läderstövlar i stället för att tvätta fötterna är alla eniga om. Om strumpor är de det inte. Ibn Rushd ställer upp partierna: Malik, al-Shafii och Abu Hanifa förbjuder, medan Abu Yusuf, Muhammad al-Shaybani och Sufyan al-Thawri tillåter, och orsaken till oenigheten är dels hur de bedömde traderingarna om att Muhammed strök över strumpor och sandaler, dels om stöveln alls kan tjäna som grund för analogi.[^20] Ibn Qayyim al-Jawziyya sammanfattar praxis med en regel som är lätt att missa: Muhammed rättade sig efter det tillstånd fötterna befann sig i, och strök när de satt i stöveln och tvättade när de var bara.[^21]
...
Den andra gäller kvinnor. Menstruationen är stor rituell orenhet och utestänger under den tiden från bönen och från vandringen kring Kaba. Ibn Rushd nämner fyra ting som hindras, al-Qurtubi elva, och Aishas hadith om att kvinnorna befalldes ta igen fastan men inte bönen löser fastefrågan utan att lösa bönefrågan.[^39] Svaret är att hadath är ett tillfälligt tillstånd, ingen egenskap hos personen, och att befrielsen från att ta igen bönerna är en lättnad, inte en utestängning: fastan tas igen därför att den är några dagar om året, bönen efterskänks därför att den annars vore femtio böner att ta ikapp. Ordningen går tillbaka på profetens egen anvisning och inte på juristernas bedömning, vilket är skälet till att den är sig lik i alla skolor. Att den ändå upplevs som ett utanförskap är en verklig erfarenhet, och den möts bäst med påminnelsen om att dhikr, duʿāʾ och läsning ur minnet står öppna hela tiden. Just menstruationsreglerna hör enligt Marion Holmes Katz till de mest omtvistade i det tidiga materialet.[^25]

Den tredje invändningen hämtas ur 9:28, där de som sätter medhjälpare vid Guds sida kallas orena.[^40] Kritiker läser versen som att icke-muslimer är fysiskt orena, och även Bernströms hakparentes, "på grund av sin avgudadyrkan", är ett tolkningsval. De klassiska rättsskolorna uppfattar *najas* här som en kultisk och andlig kvalitet knuten till versens sammanhang, tillträdet till den heliga moskén, och inte som en fysisk orenhet hos personer. Bokfolkets mat är enligt 5:5 uttryckligen tillåten, och profeten tog emot gäster, åt av deras föda och lånade av dem – vilket vore obegripligt om beröring gjorde en muslim oren.[^41] Invändningen träffar alltså inte den läsning rättsskolorna faktiskt bär.
...
[^18]: De två läsningarna av *arjul* redovisas i den klassiska recitationslitteraturen; se Ibn al-Jazari, *al-Nashr fi al-qiraat al-ashr*, samt al-Tabari, *Jami al-bayan*, kommentaren till 5:6.
...
[^24]: Ibn Qudama, *al-Mughni*, avsnittet om al-mash ala al-jabira; jämför al-Nawawi, *al-Majmu sharh al-Muhadhdhab*, samma ämne.
[^25]: Marion Holmes Katz, *Body of Text: The Emergence of the Sunni Law of Ritual Purity*, SUNY Press, 2002.
[^26]: Ze'ev Maghen, *Virtues of the Flesh: Passion and Purity in Early Islamic Jurisprudence*, Brill, 2005.
[^27]: al-Nawawi, *al-Majmu sharh al-Muhadhdhab*, bab sifat al-ghusl.
[^28]: al-Qurtubi, *al-Jami li-ahkam al-Quran*, avsnittet om istinja, som citerar Ibn al-Arabi.
[^29]: Samma verk, kommentaren till 62:9.
[^30]: MUCF, officiell statistik "Trossamfund – antal betjänade", uppgifter för 2024.
[^31]: Pew Research Center, "Europe's Growing Muslim Population", 2017.
[^32]: Förvaltningsrätten i Malmö, mål 7680-19, dom meddelad 2020-09-11.
[^33]: AD 2018 nr 51, meddelad 2018-08-15, Diskrimineringsombudsmannen mot Almega Tjänsteföretagen och Semantix Tolkjouren AB.
[^34]: SOSFS 2015:10 om basal hygien i vård och omsorg, konsoliderad version.
[^35]: Vårdhandboken, "Religion och hälsa", godkänd 2022-08-24, författare Katarina Hjelm.
[^36]: Simon Sorgenfrei, *Islam i Sverige – de första 1300 åren*, Myndigheten för stöd till trossamfund, 2018.
[^37]: Ahmad ibn Fadlan, *Risala*, berättelsen om rus vid Volga 921–922.
[^38]: Georg August Wallin, *Första resa från Cairo till Arabiska öknen i april 1845*, utgiven postumt 1853.
[^39]: Ibn Rushd, *Bidayat al-mujtahid*, kapitlet om hayd; al-Qurtubi, *al-Jami li-ahkam al-Quran*, kommentaren till 2:222.
[^40]: Koranen, al-Tawba 9:28.
[^41]: Koranen, al-Maida 5:5 om bokfolkets mat; om profetens umgänge med judar och kristna se al-Bukhari, *Sahih*, kitab al-buyu (pantsättningen av rustningen hos en judisk man) och kitab al-atima.
[^42]: Ibn al-Jawzi, *Talbis Iblis*, avsnittet om waswas vid rening och tvagning.
