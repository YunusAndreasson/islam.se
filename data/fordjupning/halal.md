...
keywords:
  ...
  - "halalkött bedövning"
  - "får muslimer äta svenskt kött"
  - "halalcertifiering Sverige"
  - "gelatin halal"
  - "skolmat fläskkött religion"
  - "obedövad slakt förbud 1937"
about:
  name: "Halal"
  sameAs:
    - "https://sv.wikipedia.org/wiki/Halal"
    - "https://www.wikidata.org/wiki/Q170208"
faq:
  - q: "Är kött från svenska butiker halal?"
    a: "Det beror på vilken lärd position man följer. Den som läser Koranen 5:5 så att kristnas och judars mat är tillåten kan äta vanligt svenskt kött; den som med Ibn Kathir menar att versens förutsättning – att skriftfolken åkallar Gud vid slakten – inte längre gäller, gör det inte. SOU 1999:9 dokumenterade minst tre olika hållningar bland svenska muslimer redan 1999."
  - q: "Varför är halalslakt tillåten i Sverige men inte koscherslakt?"
    a: "Svensk lag kräver bedövning före avblodning. Judisk skäktning förutsätter ett obedövat djur och är därför omöjlig, medan en stor del av halaltraditionen godtar reversibel bedövning som lämnar djuret levande vid snittet. Jordbruksverket beskriver själv skillnaden i dessa termer."
  - q: "Är gelatin och E-nummer halal?"
    a: "De lärda är oense. Frågan hänger på istihala – om en förbjuden substans som omvandlas kemiskt blir tillåten. Principen är klassisk och diskuteras redan hos al-Mughni och al-Majmu med vinet som blir vinäger som skolexempel; hanafitisk och malikitisk tradition tillämpar den vidare än shafiitisk och hanbalitisk. Mer restriktiva certifieringsorgan tillämpar den inte alls och betraktar svingelatin som fortsatt förbjudet."
  - q: "Vad betyder det att något är makruh?"
    a: "Makruh är en av islams fem rättsliga kategorier och betyder ogillat men inte förbjudet. Mellan halal och haram ligger också mandub (rekommenderat) och wajib (obligatoriskt). Att kalla något halal är alltså inte att kalla det gott, bara tillåtet."
  - q: "Måste Guds namn uttalas över varje djur?"
    a: "Enligt hanafitisk, malikitisk och hanbalitisk rätt är tasmiya ett villkor: utelämnas den avsiktligt blir köttet förbjudet. Enligt shafiitisk rätt är den en stark rekommendation men inte ett villkor. al-Nawawi skriver uttryckligen att köttet inte blir förbjudet om den utelämnas."
sources:
  - name: "Koranen 2:173"
  ...
  - name: "Koranen 5:5"
    url: "https://quran.com/5/5?translations=48"
  - name: "Koranen 5:90"
    url: "https://quran.com/5/90?translations=48"
  - name: "Koranen 22:37"
    url: "https://quran.com/22/37?translations=48"
  - name: "al-Nawawi, al-Majmu sharh al-Muhadhdhab, kitab al-dhabaih (om tasmiya och slaktens utförande)"
  - name: "al-Marghinani, al-Hidaya fi sharh Bidayat al-mubtadi, kitab al-dhabaih (om överflödigt lidande som makruh)"
  - name: "Ibn Qudama, al-Mughni, kitab al-dhabaih (om skriftfolkens slakt och tasmiya)"
  - name: "Ibn Rushd, Bidayat al-mujtahid, kitab al-dhabaih (om vad de lärda är eniga och oeniga om)"
  - name: "Ibn Kathir, Tafsir al-Quran al-azim, till 5:5"
  - name: "Jordbruksverket: Religiös slakt"
    url: "https://jordbruksverket.se/djur/djurtransportorer-och-slakterier/religios-slakt"
  - name: "SOU 1999:9, Att slakta ett får i Guds namn (Göran Gunner)"
    url: "https://riksdagen.se/sv/dokument-lagar/dokument/statens-offentliga-utredningar/sou-1999-9-_GNB39/html"
  - name: "Kungl. Maj:ts proposition nr 188 år 1937 med förslag till lag angående slakt av husdjur"
    url: "https://lagen.nu/prop/1937:188"
  - name: "DO: Anmälningarna om skolmaten i Uddevalla utreds inte (10 oktober 2024)"
    url: "https://www.do.se/om-do/pressrum/aktuellt/2024/2024-10-10-anmalningarna-om-skolmaten-i-uddevalla-utreds-inte"
  - name: "Livsmedelsverket: Specialkost och anpassade måltider i vård, skola och omsorg"
    url: "https://www.livsmedelsverket.se/matvanor-halsa--miljo/maltider-i-vard-skola-och-omsorg/specialkost-och-anpassade-maltider-i-vard-skola-och-omsorg/"
  - name: "Upphandlingsmyndigheten: Halalkött i offentlig upphandling"
    url: "https://www.upphandlingsmyndigheten.se/frageportalen/2801328/halalkott-i-offentlig-upphandling/"
  - name: "Svensk Fågel: Frågor och svar"
    url: "https://svenskfagel.se/fragor-och-svar/"
  - name: "Djurens Rätt: Slakt utan bedövning"
    url: "https://www.djurensratt.se/djur-i-livsmedelsindustrin/slakt-utan-bedovning"
  - name: "EFSA, Welfare aspects of the main systems of stunning and killing (2004)"
    url: "https://efsa.onlinelibrary.wiley.com/doi/10.2903/j.efsa.2004.45"
  - name: "Riaz m.fl., Pros and cons of different stunning methods from a Halal perspective, Translational Animal Science 5:4 (2021)"
    url: "https://academic.oup.com/tas/article/5/4/txab154/6387877"
  - name: "Halal Monitoring Committee: Issues of Mechanical Slaughter and Stunning"
    url: "https://halalhmc.org/resources/issues-of-mechanical-slaughter-and-stunning/"
  - name: "European Papers: Centraal Israëlitisch Consistorie van België (C-336/19)"
    url: "https://www.europeanpapers.eu/europeanforum/religious-slaughtering-stunning-matter-centraal-israelitisch-consistorie-van-belgie"
  - name: "Motion 2024/25:234 Förbud mot halal- och koscherslakt"
    url: "https://www.riksdagen.se/sv/dokument-och-lagar/dokument/motion/forbud-mot-halal-och-koscherslakt_hc02234/"
