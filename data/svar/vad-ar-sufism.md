---
title: "Vad är sufism? Islams mystik och dess gränser"
...
keywords:
  ...
  - "tasawwuf"
  - "sufiorden tariqa"
  - "sufism och sunni islam"
  - "är sufism tillåtet"
faq:
  - q: "Är sufism tillåtet i islam?"
    a: "Det beror på vad som avses. Själens rening, ånger och Guds åminnelse i profetens form är helt enkelt islam. Men innovationer (bidʿa) och att åkalla döda eller helgon (shirk) avvisas."
  ...
  - q: "Vad menas med dhikr?"
    a: "Dhikr är åminnelse av Gud genom att upprepa Hans namn och lovprisningar. I profetens form är det dyrkan; nyuppfunna kollektiva former kritiseras som bidʿa."
sources:
  - name: "Koranen 91:9–10"
    url: "https://quran.com/91/9-10?translations=48"
  - name: "Koranen 6:153"
    url: "https://quran.com/6/153?translations=48"
  - name: "Sahīh Muslim 8"
    url: "https://sunnah.com/muslim:8"
  - name: "al-ibadah.com – Innovationer (bidʿa)"
    url: "https://al-ibadah.com/troslara/innovationer"
  - name: "al-ibadah.com – Gravdyrkan"
    url: "https://al-ibadah.com/troslara/gravdyrkan"
  - name: "islamqa.info (Muhammad Sālih al-Munajjid) – Vad är sufism?"
    url: "https://islamqa.info/en/answers/47431"
  - name: "Pew Research Center – The World's Muslims (2012)"
    url: "https://www.pewresearch.org/religion/2012/08/09/the-worlds-muslims-unity-and-diversity-1-religious-affiliation/"
related:
  - "vad-ar-tawhid"
  - "vad-ar-sunna"
  - "sunni-och-shia"
...
Ordet *sufi* förknippas oftast med arabiskans *sūf*, "ull": de tidiga asketerna bar enkla yllekläder som tecken på att de vänt världen ryggen. En andra härledning kopplar det till *safāʾ*, "renhet". Säkert är att varken ordet eller en avgränsad rörelse fanns hos profeten, hans följeslagare eller de tre första generationerna (*salaf*). Tidiga gestalter som Hasan al-Basrī (d. 728) ägnade sig åt asketism (*zuhd*) och hjärtats rening utan att kalla det något särskilt; begreppet *tasawwuf* dyker upp först under 700- och 800-talen i Basra och Bagdad. Mystiken är alltså ingen främmande import, men namnet och systemet är en senare påbyggnad på något islam redan rymde. Hjärtats rening är lika gammal som uppenbarelsen; ordet *tasawwuf* limmades på först långt efteråt.

## Vad är kärnan – att rena själen?

Sufismens uttalade mål är *tazkiyat an-nafs*, själens rening, och *ihsān*, att fullkomna sin dyrkan. Båda är djupt förankrade i uppenbarelsen. Koranen gör reningen till själva skiljelinjen mellan framgång och fördärv:

> Helt visst skall det gå den väl i händer som [i detta liv] strävar efter att rena [sin själ], men den som begraver den [i synd och mörker] skall gå mot fördärvet.
> — Koranen 91:9–10

*Ihsān* definieras av profeten själv i den berömda hadithen om ängeln Jibrīl: "att du dyrkar Gud som om du ser Honom, för även om du inte ser Honom så ser Han dig" (Sahīh Muslim 8). Hit hör ånger (*tawba*), tålamod (*sabr*), tacksamhet och Guds åminnelse (*dhikr*), allt sådant som Koranen prisar. Denna kärna är ingen gren vid sidan av islam; den är islam, levd inifrån.
