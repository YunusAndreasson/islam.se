...
{
  "verdict": "deepened",
  "thesis": "Amānah — det moraliska ansvaret — kräver en bärare som kan välja och fela, och genom att delegera beslut till algoritmer urholkar vi den förmåga som gör oss mänskliga.",
  "argumentChain": [
    "Steg 1: Koranen presenterar bergen som vägrar amānah eftersom de förstår bördan; människan accepterar trots sin benägenhet till synd — amānah kräver en bärare som kan fela.",
    "Steg 2: Ibn Qayyims hjärta-som-konung-metafor definierar beslut som medveten styrning, inte beräkning — att regera kräver det bergen saknade.",
    "Steg 3: Modern AI ersätter konungen (inte rådgivaren) — formell mänsklig tillsyn blir tom när människan saknar tid, kunskap eller incitament att faktiskt överpröva.",
    "Steg 4: Ansvarsluckan: varken utvecklare, användare eller maskin bär fullt ansvar; islam förbjuder sådan upplösning — varje själ är individuellt ansvarig.",
    "Steg 5: Ghaflah: faran är att människan som delegerar slutar vara vaken — vanan att inte besluta urholkar amānah inifrån.",
    "Steg 6: Ellen Key bekräftar och fördjupar: förnedringen ligger inte i felet utan i flykten från dess följder — algoritmisk delegering är ghaflah som affärsmodell.",
    "Steg 7: Khalīfah kräver en uppdragstagare som kan svara; algoritmen saknar det inför vilket svaret avges.",
    "Steg 8: Precision är inte rättvisa — bergens felfria lydnad diskvalificerade dem; amānah förutsätter möjligheten att svika.",
    "Steg 9: Maqāṣid tillåter verktyg men beslutsögonblicket måste förbli mänskligt — klick-bekräftelse är gest, inte dom.",
    "Steg 10: Slutsats: frågan är om vi genom att låta maskiner besluta långsamt ångrar det ja som gjorde oss mänskliga."
  ],
  "gaps": [
    {
      "location": "Ställföreträdandets villkor, stycke 2 (precision/rättvisa-passagen)",
      "type": "missing-step",
      "description": "Essän påstår att bergens felfria lydnad diskvalificerade dem och att valmöjligheten gör ett beslut moraliskt — men visar aldrig VARFÖR förmågan att fela kvalificerar snarare än diskvalificerar. Resonemangssteget som saknas: moralisk tyngd uppstår bara i glappet mellan vad en varelse kunde göra och borde göra; utan det glappet är lydnad inte dygd utan fysik."
    }
  ],
  "changes": [
    {
      "location": "Ställföreträdandets villkor, stycke 2",
      "type": "added-step",
      "before": "Bergen lydde redan felfritt — och det var just det som diskvalificerade dem. *Amānah* förutsätter att bäraren kan svika förtroendet. Det är valmöjligheten, inte utfallet, som gör ett beslut moraliskt.",
      "after": "Bergen lydde redan felfritt — och det var just det som diskvalificerade dem. Moralisk tyngd uppstår bara i glappet mellan vad en varelse *kunde* göra och vad den *borde* göra; den som bara kan producera ett utfall bär ingen tyngd i att producera det. Bergens lydnad var inte dygd utan fysik. *Amānah* förutsätter att bäraren kan svika förtroendet — det är valmöjligheten, inte utfallet, som gör ett beslut moraliskt.",
      "reasoning": "Lägger till det ontologiska resonemangssteget som förklarar VARFÖR förmågan att fela kvalificerar: moralisk tyngd konstitueras av glappet mellan alternativen, och utan det glappet är lydnad nödvändighet, inte val."
    }
  ],
  "changesCount": 1,
  "summary": "Essän argumenterar väl genom hela kedjan med ett undantag: den centrala insikten att bergens felfrihet diskvalificerade dem påstås utan att mekanismen visas. Tillägget (36 ord) explicerar varför: moralisk tyngd existerar bara där ett genuint alternativ finns — utan det glappet är lydnad fysik, inte dygd. Resten av essän har stark argumentationskedja utan luckor värda att fylla."
}
---
...
Den koraniska termen är *amānah*. Ordet rymmer mer än "förtroende" eller "ansvar": det betecknar den moraliska förmågan — att välja rätt och stå till svars för valet. Exegeterna har aldrig enats — al-Tabari betonade lydnadsaspekten, al-Qurtubi den moraliska medvetenhetens bredd, andra en hänvisning till *tawḥīd* eller shariaförpliktelserna i stort.[^2] Men oavsett tolkning kvarstår versens bärande påstående: *amānah* kräver en bärare som kan bäva, som kan välja, som kan fela. Bergen kunde inte fela. Därför kunde de inte bära. Det är föräldern vid sjuksängen som måste välja behandling när inget alternativ är gott.

Fjorton århundraden senare bygger vi system som beslutar om domar, anställningar, kreditvärdighet och medicinsk triage. Systemen felbedömer. Men de kan inte bäva.
...
Det svenska rättssystemet vilar på en enkel premiss: någon måste vara ansvarig. Ansvarsfrihet är undantaget — den som sover, den som är sinnessjuk, den som handlar under tvång. Ansvarsutkrävande är regeln. Obarmhärtigt formulerade Strindberg principen: "Den som sover är icke ansvarig för sina handlingar."[^6] Innebörden är lika tydlig: den som är vaken *är* det.
...
Ingen sådan upplösning tillåter Koranen. "Varje själ är ansvarig för vad den har gjort"[^8] — formuleringen är enskild, odelbar. Ansvaret kan inte fördelas, delegeras, automatiseras. En syndare bär inte en annan syndares börda.[^9] Häri ligger *amānahs* kärna: förtroendet gavs till varje människa, inte till institutioner, inte till system, inte till processer.
...
Detta problem har alignment-forskningen försökt lösa genom att förankra maskiner i mänskliga värderingar. Redan begreppet bristande samstämmighet förutsätter något att stämma överens med — ett inre liv. Maskinen har inget.
...
*Wussiḍa al-amr ilā ghayr ahlih* — "uppgiften anförtros den som inte är dess folk." Orden träffar varje automatiserat beslut som fattas utan moralisk bärare. En algoritm kan vara mer *precis* än en människa. Men precision är inte rättvisa. Bergen lydde redan felfritt — och det var just det som diskvalificerade dem. Moralisk tyngd uppstår bara i glappet mellan vad en varelse *kunde* göra och vad den *borde* göra; den som bara kan producera ett utfall bär ingen tyngd i att producera det. Bergens lydnad var inte dygd utan fysik. *Amānah* förutsätter att bäraren kan svika förtroendet — det är valmöjligheten, inte utfallet, som gör ett beslut moraliskt. Ibn Taymiyyah definierade rättvisa som att behandla lika fall lika och skilja mellan det som verkligen skiljer sig åt — att förstå saker som de är och fullända dem.[^16] Att *förstå saker som de är* kräver mer än mönsterigenkänning. Det kräver den medvetna viljan att se. Det är domaren som förstår att två stölder inte är samma brott.
...
Men erbjudandet står kvar. Varje ögonblick där en människa beslutar, medveten om beslutets tyngd, är ett ögonblick där *amānah* bärs. Överlåts beslutet till något som inte kan bäva, urholkas det som gör oss mänskliga.
...
[^7]: Begreppet *responsibility gap* myntades av Andreas Matthias, "The responsibility gap: Ascribing responsibility for the actions of learning automata", *Ethics and Information Technology* 6 (2004), s. 175–183. Se även Filippo Santoni de Sio & Giulio Mecacci, "Four Responsibility Gaps with Artificial Intelligence", *Philosophy & Technology* 34 (2021), s. 1057–1084.
[^8]: Koranen, al-Muddaththir 74:38.
[^9]: Koranen, Fāṭir 35:18.
[^10]: Ibn Ḥazm al-Andalusī, *al-Taqrīb li-Ḥadd al-Manṭiq*.
[^11]: Ibn Qayyim al-Jawziyyah, *Madārij al-Sālikīn*. I *al-Wābil al-Ṣayyib* utvecklar han temat: "*Ghaflah* är hjärtats sömn inför sökandet efter detta liv, och det är en slöja över det; om denna slöja inte lyfts genom åminnelse förtjockas den."
[^12]: Ellen Key, *Barnets århundrade*.
[^13]: Ellen Key, *Lifslinjer*, första delen.
[^14]: Koranen, Ṣād 38:26.
[^15]: al-Nawawī, *Riyāḍ al-Ṣāliḥīn*, kapitlet om *amānah*, via Ṣaḥīḥ al-Bukhārī.
[^16]: Ibn Taymiyyah, *al-Radd ʿalā al-Manṭiqiyyīn*.
[^17]: Ibn Khaldūn, *Muqaddimah*.
[^18]: Oscar Levertin, *Diktare och drömmare*.
[^19]: Parasuraman & Manzey, "Complacency and Bias in Human Use of Automation: An Attentional Integration", *Human Factors* 52:3 (2010), s. 381–410.
[^20]: Hannah Arendt, *On Violence* (1970). Jfr *The Human Condition* (1958).
