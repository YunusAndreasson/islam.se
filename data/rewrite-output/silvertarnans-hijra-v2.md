---
{
  ...
  "reflection": "Essäns styrka är att fågeln inte illustrerar argumentet utan *är* argumentet — varje avsnitt återvänder till tärnan och hittar något nytt. Ibn Qayyims treställiga distinktion (lättja / rastlös ångest / tawakkul) blev det intellektuella navet, och insikten att vilan finns *i* ansträngningen borde vara det som stannar kvar hos läsaren. 'För/mot'-distinktionen i avsnitt två (förberedelse *för* vs. skydd *mot*) ger den sekulära läsaren en ingång som den islamiska traditionen sedan fördjupar. Osäkerheten gäller om den korta Beck-passagen bär tillräcklig vikt ensam, men kontrasten mot fågeln bär den utan mer sociologi.",
  "struggles": "Att nå rätt ordantal utan utfyllnad. De strukna citaten (Key, Bremer, Kierkegaard, Strindbergs försäkringsman) lämnade luckor som krävde att kvarvarande avsnitt bar tyngre. Svårast var Ibn Qayyims poäng om att vilan finns *i* ansträngningen — att uttrycka det konkret utan att bli abstrakt eller predikoaktig. Kirurgmetaforen fick lösa det.",
  "efficiencySuggestions": "En färdig svensk översättning av Madārij-stycket hade sparat tid. Ett förtydligande i briefen om huruvida Strindbergs Svarta fanor-citat om flyttfåglars gåta räknas som 'Strindberg att stryka' eller som 'fågelmaterial att behålla' — det hade passat i avsnitt fyra."
}
---
...
> Den som berövar sig själv det nödvändiga i *tawakkuls* namn har brutit mot profetens ﷺ väg.[^7]
...
Profeten Muhammad ﷺ tog fågeln i bruk:
...
[^13]: Titeln anspelar på *hijrah*, Profetens ﷺ utvandring från Mecka till Medina år 622 – den händelse som inleder den islamiska tideräkningen. Han lämnade sitt hem under dödshot, utan garanti om ankomst, med tillit till Allah ﷻ som enda försäkring.
