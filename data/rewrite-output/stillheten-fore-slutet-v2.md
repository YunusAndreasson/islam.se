---
{
  ...
  "reflection": "Essäns hjärta är Günther Anders' 'Apokalypse ohne Reich' – undergång utan rike. Inversionen sker i mötet med Ibn Qayyim: ångesten visar sig vara förklädd längtan. Det starkaste partiet är de fyra meningarna efter Ibn Qayyim ('Tanken är skoningslös i sin enkelhet...') – de tvingar läsaren att inse att klimatångesten inte är ett informationsproblem utan ett metafysiskt. Osäkerhet: Rydberg bär mycket vikt i del ett. Om läsaren inte köper premissen att Ragnarök rymmer tröst faller kontrasten med Anders.",
  "struggles": "Att kondensera Ragnarök-materialet till en enda funktion (tröst) utan att tappa dess tyngd. Rydberg har mycket att säga – urvalet tvingar mig att välja en enda poäng: livet räddar sig men räddningen är opersonlig. Martinsons Aniara-rad hör till ångesten, inte till Ragnarök – placerade den som brygga mellan Anders och Ibn Qayyim. Att stryka Rökstenen var smärtsamt; den är intressant men tangentiell när ångesten – inte arkeologin – är essäns ärende.",
  "efficiencySuggestions": "En kontrollerad svensk översättning av Anders' nyckelpassager hade sparkat tid – jag översätter fritt från konceptet, inte från en exakt text. Ibn Qayyims passage om ångest som längtan behöver exakt sidnummer i al-Dāʾ wa-l-Dawāʾ för fullständig källhänvisning."
}
---
...
[^1]: Viktor Rydberg, *Undersökningar i germanisk mytologi*, vol. 1, kapitlet om Ragnarök och världsförnyelse. Engelsk översättning: *Teutonic Mythology: Gods and Goddesses of the Northland*.
[^2]: Günther Anders, *Endzeit und Zeitenende: Gedanken über die atomare Situation* (1972). Anders (1902–1992), österrikisk-judisk filosof, utvecklade begreppet *Apokalypse ohne Reich* för kärnvapenålderns meningslösa undergång.
[^3]: Harry Martinson, *Aniara: En revy om människan i tid och rum*, Bonniers, 1956.
[^4]: Koranen, al-Maʿārij 70:19.
[^5]: Ibn Qayyim al-Jawziyyah, *al-Dāʾ wa-l-Dawāʾ* (Sjukdomen och boten). Svensk översättning av artikelförfattaren.
[^6]: Koranen, al-Anbiyāʾ 21:104.
[^7]: Ibn Kathīr, *Tafsīr al-Qurʾān al-ʿAẓīm*, kommentar till 21:104.
[^8]: Ibn Taymiyyah, *al-ʿUbūdiyyah* (Om tjänarskapet). Svensk översättning av artikelförfattaren.
[^9]: Koranen, al-Sharḥ 94:5–6.
[^10]: Koranen, Yūsuf 12:87.
