---
{
  ...
  "reflection": "Essäns motor: inversionen att elden inte är blind kraft utan den mest seende. Det gör den vanligaste invändningen mot helvetesläran till sin egen vederläggning. Ibn Qayyims förskjutning från framtida eld till inre visshet ger ett andra lager utan att dubblera det första. Ibn Kathīrs läsning av flodbäddarna som hjärtans olikhet är tagen från originalversionen och inte verifierad mot arabisk tafsīr.",
  "struggles": "Att undvika parallellstrukturen som originalet föll i. Tre traditioner sida vid sida ger jämförelse, inte argument. Att eskalera inom den islamiska traditionen krävde att varje steg tillför något det föregående inte kunde visa ensamt. Att ge Herakleitos och nordisk myt nog utrymme att fylla sin kontrastfunktion utan att de tar över.",
  "efficiencySuggestions": "Färdiga svenska översättningar av Ibn Rajabs al-Takhwīf. En kuraterad samling Ibn Qayyim-passager om eld och rening snarare än hela Madārij eller Rawḍa. Tydligare markering i diagnosbrevet av vilka formuleringar från originalet som får behållas ordagrant."
}
---
...
Skillnaden mot Koranens eld är inte gradskillnad utan artskillnad. Herakleitos' eld dömer utan att skilja. Surts eld förvandlar utan att välja. Ingen av dem äger det som gör den koraniska elden till något annat: en blick. En eld som inte bara verkar *på* den prövade utan svarar *mot* vad den möter.
