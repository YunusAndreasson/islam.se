---
{
  ...
  "reflection": "Swedenborg-ramen bär essän: en historisk gestalt vars kartläggning var så exakt att frånvaron av själen bland hans fynd blir meningsfull, inte trivial. Inversionen landar i Gränsen-sektionen — läsaren har gått med på att frånvaron är tillfällig, och Koranen avslöjar att den är permanent, och att det är poängen. Khalq/amr-distinktionen gör åtskillnaden begriplig utan att kräva teologiska förkunskaper.",
  "struggles": "Att stryka Dennett, Wittgenstein, Nagel, Levertin och Levine tog bort variationen av västerländska röster. Utmaningen var att ersätta dem med fördjupning av kvarvarande material snarare än nya källor. Khalq/amr-sektionen krävde mest arbete: teologisk precision i essäistisk ton.",
  "efficiencySuggestions": "Förverifierade Ibn Qayyim-citat med volym och sidnummer hade sparat osäkerhet. En kort kronologi över Swedenborgs karriärfaser (årtal för anatomiska verk kontra visionära) hade gett säkrare detaljer i öppning och avslutning. Diagnosbrevets båge var exceptionellt tydlig — denna detaljnivå bör vara standard för omskrivningar."
}
---
...
Ögat ser formen. Örat hör tonen. Skalpellen kartlägger vävnaden. Ingen av dem korsar gränsen till *amr*. De arbetar med lera och kan inte nå det som instiftades genom ord. Häri ligger ingen förkastelse av Swedenborgs vetenskap – utan dess avgränsning. Skalpellen ger sann kunskap om det den når. Den når inte allt.
