...
För att förstå vad som står på spel måste vi först förstå hur det andliga ljuset beskrivs i den tradition som levt längst med mörkret. I Koranen är ljus inte bara metafor utan kosmologisk kategori. Den mest kommenterade versen i hela den islamiska idéhistorien — ljusversen, *ayat al-nur* — gestaltar ljuset i en flerlagrad bild:
...
Bilden rör sig inåt: från nischen till glaset till lampan till oljan som nästan lyser av sig själv. Ibn Qayyim kartlägger i *al-Wabil al-Sayyib* hur ljuset i hjärtat föds ur tro och lydnad — det närs av uppenbarelse och goda handlingar så som lampans låga närs av olja. När ljuset träder in i hjärtat vidgas det och öppnar sig. Hjärtat fylls av insikt som inte härrör från diskursivt tänkande utan från den troende tjänarens närhet till sin Herre.[^3] Det är att plötsligt se sambandet mellan två verser som lästs hundra gånger var för sig.

Ibn Qayyim blottlägger det avgörande sambandet: uppenbarelsens ljus *adderas* till den medfödda naturens ljus, *fitrah*, och de två förenas till *nurun ala nur* — ljus på ljus. Det är vad barnet vet innan det lärt sig namnet på det det vet. Utan denna addition saknas den insikt som skiljer sant från falskt.[^4] Det gudomliga ljuset konkurrerar inte med det naturliga. Det förutsätter det. Och inom denna hierarki blir det synligt: grunden för det naturliga ljuset är erfarenheten av verkligt mörker.

## Motargumentet — och varför det inte räcker helt

En invändning är uppenbar: om det gudomliga ljuset till sitt väsen transcenderar det fysiska — om det, som Koranen slår fast, är Allah ﷻ själv som vägleder till Sitt ljus[^5] — varför skulle ljusförorening vara ett teologiskt problem?

Invändningen väger tungt. Det ljus som Koranen omnämner i *ayat al-nur* är inte fotoner utan vägledning, tro, insikt som Allah ﷻ lägger i den troendes hjärta. Ingen mängd artificiellt ljus kan hindra Allah ﷻ från att vägleda den Han vill vägleda.

Men Koranen själv förankrar erkännandet i den fysiska erfarenheten av ljus och mörker. Den jämställer ljusversen och mörkerbilden i samma sura, som om den ena inte kan förstås utan den andra. Fem verser efter *nurun ala nur* kommer detta:
...
Koranen tilltalar människor som *vet* hur mörker känns — som har stått i det och känt sin egen hjälplöshet. Den fysiska erfarenheten är inte ljusets källa, men väl den jordmån ur vilken erkännandet växer. I denna jordmån identifierar Ibn Qayyim i *Ighathat al-Lahfan* en av hjärtats sjukdomar: ljuset fördunklas av ständig stimulans; den som vill återfå sin *basira* — sin inre syn — måste dra sig tillbaka från det som bländar.[^7] Den som stänger fliken, stiger upp från skärmen, går ut i tystnaden. Det som stiger bortom det fysiska måste ha *börjat* i det fysiska. Tar man bort jordmånen upphör inte sanningen — men färre ögon finner den.

## Natten som andligt villkor

Att det fysiska mörkret formar det andliga medvetandet är inte spekulation: Islam behandlar natten som sakral tid, liturgiskt snarare än metaforiskt. Profeten ﷺ utpekade nattbönen, *qiyam al-layl*, som den förnämsta frivilliga bönen: "den bästa bönen efter de föreskrivna är nattens bön."[^8] I natten förlägger Koranen sin egen uppenbarelses höjdpunkt: "Ödesbestämmelsens natt är bättre än tusen månader."[^9] Profetens ﷺ nattliga resa, *isra wa-l-mi'raj*, sker i mörker.
...
Natten *dras fram* som ett tecken. Koranen anför detta direkt efter talet om solen som rör sig mot sitt bestämda mål. Natten är solens jämbördiga, inte dess frånvaro.

## Söderbergs kägla

Den svenske författaren Hjalmar Söderberg lägger i början av 1900-talet i doktor Glas mun en observation som överskrider romanen:

> Det är den smala koniska skuggan af vår lilla planet. En liten spetsig kägla af mörker midt i ett haf af ljus.[^11]

Mörkret är inte det kosmiska normaltillståndet utan ett undantag, skört och geometriskt begränsat. Ljuset dominerar universum; mörkret är en lokal anomali som möjliggör varseblivning.
...
Återvänd till ramverket: Ibn Qayyim definierar hjärtats ljus som det som skiljer sant från falskt, den äkta utsagan från den lögnaktiga.[^18] *Firasa*, den andliga urskillningsförmågan, är en frukt av detta ljus, och ljuset i sin tur en frukt av att sänka blicken inför det som bländar.[^19] Det är att veta vem som ljuger innan de talar färdigt. Den som vill *se* måste först lära sig att *inte se*.
...
Guds ljus *framträder* i natten. Stjärnornas ljus är saligt just för att det visar sig mot mörker. Den som aldrig sett stjärnor mot en svart himmel kan förstå meningen intellektuellt. Men att erfara den, att stå under en oändlig himmel och känna sin egen litenhet som befrielse — det kräver mörker.

Koranen ger stjärnorna just denna roll: "Det är Han som har gett er stjärnorna för att ni genom dem skall kunna finna er väg i landets och havets mörker."[^21] Stjärnorna är vägvisare — och de fungerar bara i mörker. Och det de leder mot — sammanhanget i sura *al-An'am* tydliggör det — är mer än en fysisk destination: en tacksamhet född ur erfarenheten av egen hjälplöshet.
...
[^5]: Koranen, al-Nur 24:35: "Allah ﷻ vägleder till Sitt ljus den Han vill."
